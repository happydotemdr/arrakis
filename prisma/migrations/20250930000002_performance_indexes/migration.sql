...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_conversations_updated_at_desc
ON conversations (updated_at DESC);

-- Conversations: Session lookup (used frequently in hooks)
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_conversations_session_id_not_null
